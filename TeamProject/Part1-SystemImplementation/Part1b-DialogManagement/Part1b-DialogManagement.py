...
def main():
    print(
        "Hello, welcome to the Group 30 restaurant recommendation system. You can ask for restaurants by area, price range or food type. How may I help you?")
    ...
    while True:
        ...
        print(predicted_label, " | ", utterance, '(', preferenceField['area'], ' ', preferenceField['pricerange'], ' ',
              preferenceField['food'], ')')
        ...
        if next_state == 9:
            ...
            if len(candidate_restaurants) == 0:
                candidate_restaurants = find_restaurants(preferenceField['area'], preferenceField['pricerange'],
                                                         preferenceField['food'])
